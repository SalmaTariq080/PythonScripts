...
est_info_dict={}
for seq_record in SeqIO.parse("/home/salma/Desktop/Final_Project/NCBI_Smaller_est_greaterthan5_dataset/xab", "fasta"):#replace test_file_est.fasta with Zea_mays.txt 
...
def Extract_Blat_Output(input_file):
    output_file = open("/home/salma/Desktop/Final_Project/NCBI_Smaller_est_greaterthan5_dataset/xaa_info.csv","a")
